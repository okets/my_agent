...
When the user types `/my-agent:auth`, this presents the auth method choice (API key or Claude subscription), validates the credentials, and stores them in `.env`.
