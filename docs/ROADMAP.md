...
| **M9.6: Capability Resilience & Recovery** | **In Progress** | S1 done (raw-media persistence + CFR detector, 43 tests). S2–S7 pending. **Blocks M10 and all downstream work.** [plan.md](sprints/m9.6-capability-resilience/plan.md) |
