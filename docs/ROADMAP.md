...
| **M9.6: Capability Resilience & Recovery** | **Done** | 21 sprints. All 6 production wiring bugs (BUG-1 through BUG-6) fixed and verified end-to-end in live retest 2026-04-21. Full recovery chain confirmed: STT gate → transcription → BUG-6 TTS-degraded acknowledgment → correct brain reply. |
...
| S21 | M9.6 milestone-close fix sprint — production wiring bugs from S20 live test + brain-awareness gap from S21 retest | **Done** | All 6 production bugs fixed. BUG-1: `AckDelivery` wired with live `TransportManager`. BUG-2: brain-CFR race gate (STT hold). BUG-3: `reverifyAudioToText → reprocessTurn` chain. BUG-4: terse SKILL.md synced to instance. BUG-5: `cfr-exit-gate-automation` precondition. BUG-6: `VOICE_MODE_HINT` missing from gate-resolved path; system prompt degraded-capability injection added. Live retest 2026-04-21: full recovery chain verified end-to-end. CTO verdict: "worked pretty well." **M9.6 closed. M10 unblocked.** [§2.6](sprints/m9.6-capability-resilience/plan-phase3-refinements.md#26-sprint-21--m96-milestone-close-fix-sprint) · [Live retest](sprints/m9.6-capability-resilience/s21-live-retest.md) · [Decisions](sprints/m9.6-capability-resilience/s21-DECISIONS.md) · [Review](sprints/m9.6-capability-resilience/s21-review.md) |
