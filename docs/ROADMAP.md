...
| **M9.6: Capability Resilience & Recovery** | **Re-Opened** | Phase 1 (S1-S8) + Phase 2 (S9-S14 done). S14 shipped friendly names + multi-instance copy + factory DI. 4 sprints remaining (S15-S18). |
